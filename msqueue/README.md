...
[![Build Status](https://travis-ci.com/ITMO-MPP-2018/msqueue-Dogzik.svg?token=B2yLGFz6qwxKVjbLm9Ak&branch=master)](https://travis-ci.com/ITMO-MPP-2018/msqueue-Dogzik)
...
Перед сдачей задания замените `Dogzik` в начале данного файла на свой логин в GitHub для получения информации о сборке в Travis. Это нужно сделать в двух местах: ссылка на картинку и на билд в Travis-е.
